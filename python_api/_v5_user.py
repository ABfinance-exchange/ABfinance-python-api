...
class UserHTTP(_V5HTTPManager):
    def create_sub_uid(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/create-subuid
        """
    ...
    def create_sub_api_key(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/create-subuid-apikey
        """
        return self._submit_request(
            method="POST",
    ...
    def get_sub_uid_list(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/subuid-list
        """
        return self._submit_request(
            method="GET",
    ...
    def get_sub_uid_list_unlimited(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/page-subuid
        """
        return self._submit_request(
            method="GET",
    ...
    def freeze_sub_uid(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/froze-subuid
        """
        return self._submit_request(
            method="POST",
    ...
    def get_api_key_information(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/apikey-info
        """
        return self._submit_request(
            method="GET",
    ...
    def modify_master_api_key(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/modify-master-apikey
        """
        return self._submit_request(
            method="POST",
    ...
    def modify_sub_api_key(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/modify-sub-apikey
        """
        return self._submit_request(
            method="POST",
    ...
    def delete_master_api_key(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/rm-master-apikey
        """
        return self._submit_request(
            method="POST",
    ...
    def delete_sub_api_key(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/rm-sub-apikey
        """
        return self._submit_request(
            method="POST",
    ...
    def delete_sub_uid(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/rm-subuid
        """
        return self._submit_request(
            method="POST",
    ...
    def get_all_sub_api_keys(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/list-sub-apikeys
        """
        return self._submit_request(
            method="GET",
    ...
    def get_uid_wallet_type(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/wallet-type
        """
        return self._submit_request(
            method="GET",
    ...
    def get_escrow_sub_members(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/user/escrow-sub-members
        """
        return self._submit_request(
            method="GET",
