...
class MarketHTTP(_V5HTTPManager):
    def get_server_time(self) -> dict:
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/market/time
        """
    ...
    def get_kline(self, **kwargs) -> dict:
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/market/kline
        """
        return self._submit_request(
            method="GET",
    ...
    def get_instruments_info(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/market/instrument
        """
        return self._submit_request(
            method="GET",
    ...
    def get_orderbook(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/market/orderbook
        """
        return self._submit_request(
            method="GET",
    ...
    def get_tickers(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/market/tickers
        """
        return self._submit_request(
            method="GET",
    ...
    def get_public_trade_history(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/market/recent-trade
        """
        return self._submit_request(
            method="GET",
    ...
    def get_price_limit(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/market/order-price-limit
        """
        return self._submit_request(
            method="GET",
    ...
    def get_rpi_orderbook(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/market/orderbook-rpi
        """
        return self._submit_request(
            method="GET",
    ...
    def get_index_price_components(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/market/index-price-components
        """
        return self._submit_request(
            method="GET",
