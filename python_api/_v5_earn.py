...
class EarnHTTP(_V5HTTPManager):
    def get_earn_product_info(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/earn/product-info
        """
    ...
    def stake_or_redeem(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/earn/create-order
        """
        return self._submit_request(
            method="POST",
    ...
    def get_stake_or_redemption_history(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/earn/order-history
        """
        return self._submit_request(
            method="GET",
    ...
    def get_staked_position(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/earn/position
        """
        return self._submit_request(
            method="GET",
    ...
    def get_yield(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/earn/yield
        """
        return self._submit_request(
            method="GET",
    ...
    def get_hourly_yield(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/earn/hourly-yield
        """
        return self._submit_request(
            method="GET",
