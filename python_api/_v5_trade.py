...
class TradeHTTP(_V5HTTPManager):
    def place_order(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/create-order
        """
    ...
    def amend_order(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/amend-order
        """
        return self._submit_request(
            method="POST",
    ...
    def cancel_order(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/cancel-order
        """
        return self._submit_request(
            method="POST",
    ...
    def get_open_orders(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/open-order
        """
        return self._submit_request(
            method="GET",
    ...
    def cancel_all_orders(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/cancel-all
        """
        return self._submit_request(
            method="POST",
    ...
    def get_order_history(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/order-list
        """
        return self._submit_request(
            method="GET",
    ...
    def place_batch_order(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/batch-place
        """
        return self._submit_request(
            method="POST",
    ...
    def amend_batch_order(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/batch-amend
        """
        return self._submit_request(
            method="POST",
    ...
    def cancel_batch_order(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/batch-cancel
        """
        return self._submit_request(
            method="POST",
    ...
    def get_borrow_quota(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/spot-borrow-quota
        """
        return self._submit_request(
            method="GET",
    ...
    def set_dcp(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/dcp
        """
        return self._submit_request(
            method="POST",
    ...
    def get_executions(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/order/execution
        """
        return self._submit_request(
            method="GET",
