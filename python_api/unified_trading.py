...
from python_api.exceptions import (
...
class WebSocket(_V5WebSocketManager):
    ...
    def position_stream(self, callback):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/private/position
        """
    ...
    def order_stream(self, callback):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/private/order
        """
        self._validate_private_topic()
        topic = "order"
        self.subscribe(topic, callback)
    ...
    def execution_stream(self, callback):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/private/execution
        """
        self._validate_private_topic()
        topic = "execution"
        self.subscribe(topic, callback)
    ...
    def fast_execution_stream(self, callback, categorised_topic=""):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/private/fast-execution
        """
        self._validate_private_topic()
    ...
    def wallet_stream(self, callback):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/private/wallet
        """
        self._validate_private_topic()
        topic = "wallet"
        self.subscribe(topic, callback)
    ...
    def greek_stream(self, callback):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/private/greek
        """
        self._validate_private_topic()
        topic = "greeks"
        self.subscribe(topic, callback)
    ...
    def orderbook_stream(self, depth: int, symbol: (str, list), callback):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/public/orderbook
        """
    ...
    def rpi_orderbook_stream(self, symbol: (str, list), callback):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/public/orderbook-rpi
        """
        self._validate_public_topic()
    ...
    def trade_stream(self, symbol: (str, list), callback):
        ...
        Required args:
         ...
         Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/public/trade
        """
        self._validate_public_topic()
    ...
    def ticker_stream(self, symbol: (str, list), callback):
        ...
        Required args:
         ...
         Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/public/ticker
        """
        self._validate_public_topic()
    ...
    def kline_stream(self, interval: int, symbol: (str, list), callback):
        ...
        Required args:
         ...
         Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/public/kline
        """
        self._validate_public_topic()
    ...
    def liquidation_stream(self, symbol: (str, list), callback):
        ...
        Required args:
         ...
         Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/public/liquidation
        """
    ...
    def all_liquidation_stream(self, symbol: (str, list), callback):
        ...
        Required args:
         ...
         Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/public/all-liquidation
        """
        self._validate_public_topic()
    ...
    def insurance_pool_stream(self, contract_group: (str, list), callback):
        ...
        Required args:
         ...
         Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/public/insurance-pool
        """
        self._validate_public_topic()
    ...
    def price_limit_stream(self, symbol: str, callback):
        ...
        Required args:
         ...
         Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/public/order-price-limit
        """
        self._validate_public_topic()
    ...
    def system_status_stream(self, callback):
        ...
        Push frequency: N/A
         ...
         Additional information:
            https://abfinance-exchange.github.io/docs/v5/websocket/system/system-status
        """
