...
class AccountHTTP(_V5HTTPManager):
    def get_wallet_balance(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/wallet-balance
        """
    ...
    def get_transferable_amount(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/unified-trans-amnt
        """
        return self._submit_request(
            method="GET",
    ...
    def get_borrow_history(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/borrow-history
        """
        return self._submit_request(
            method="GET",
    ...
    def get_collateral_info(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/collateral-info
        """
        return self._submit_request(
            method="GET",
    ...
    def set_collateral_coin(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/set-collateral
        """
        return self._submit_request(
            method="POST",
    ...
    def batch_set_collateral_coin(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/batch-set-collateral
        """
        return self._submit_request(
            method="POST",
    ...
    def get_fee_rates(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/fee-rate
        """
        return self._submit_request(
            method="GET",
    ...
    def get_account_info(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/account-info
        """
        return self._submit_request(
            method="GET",
    ...
    def get_transaction_log(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/transaction-log
        """
        return self._submit_request(
            method="GET",
    ...
    def get_mmp_state(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/get-mmp-state
        """
        return self._submit_request(
            method="GET",
    ...
    def get_instruments_info(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/instruments-info
        """
        return self._submit_request(
            method="GET",
    ...
    def query_dcp_info(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/dcp-info
        """
        return self._submit_request(
            method="GET",
    ...
    def get_smp_group(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/smp-group
        """
        return self._submit_request(
            method="GET",
    ...
    def set_limit_price_action(self, **kwargs):
        ...
        Additional information:
            https://abfinance-exchange.github.io/docs/v5/account/set-limit-px-action
        """
        return self._submit_request(
            method="POST",
